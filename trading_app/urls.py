...
urlpatterns = [
    ...
    path('brokers/<int:broker_id>/saxo/auth-url/', views.saxo_auth_url, name='saxo_auth_url_broker'),
    path('brokers/<int:broker_id>/exchange-auth-code/', views.exchange_auth_code, name='exchange_auth_code'),
