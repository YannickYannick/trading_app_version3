    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="trading_app.assettype"
            ),
        ),
        migrations.AddField(
            model_name="assettradable",
            name="market",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="trading_app.market"
            ),
        ),
        migrations.AddIndex(
            model_name="allassets",
            index=models.Index(
                fields=["platform", "asset_type"], name="trading_app_platfor_13a3b5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="allassets",
            index=models.Index(fields=["symbol"], name="trading_app_symbol_424f8e_idx"),
        ),
        migrations.AddIndex(
            model_name="allassets",
            index=models.Index(fields=["name"], name="trading_app_name_574d09_idx"),
        ),
        ...
        migrations.AddIndex(
            model_name="pendingorder",
            index=models.Index(
                fields=["all_asset", "status"], name="trading_app_all_ass_1855b9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="pendingorder",
